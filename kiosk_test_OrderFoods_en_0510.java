...
public class kiosk_test_OrderFoods_en_0510 extends TestCase {
	...
	public void test_OrderFoods_en_0510() {
		...
		//选择另一加餐馆SchoolFood
		commonOperater.findElementByText(kiosk_paras.btn_Menu_en).click();
		commonOperater.sleep(2);
		...
		//选择信用卡支付
		commonOperater.findElementByText(kiosk_paras.pay_QR_en).click();
		commonOperater.sleep(2);
